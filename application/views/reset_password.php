...
<form method="post" id="resetpassword" action="<?= base_url().'api/v1/Resetpass/changepassword/'.$uid; ?>" autocomplete="off">
  ...
  $(function(){
    ...
    $("#resetpassword").validate({
      ...
      $.ajax({
          ...
          url: "<?php echo base_url().'index.php/api/v1/Resetpass/reset/'.$uid; ?>"
          ,
          type: 'POST',
