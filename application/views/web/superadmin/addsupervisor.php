  ...
  <div class="col-xs-12">
    <div class="box">
      <div class="box-header">
        <h3 class="box-title"><b>Add Supervisor</b></h3>
      </div><!-- /.box-header -->
      <div class="box-body">
...
<form name="addcompanyhead" id="addcompanyhead" method="post" action="<?php echo base_url()?>web/Superadmin/supervisorprocess">
...
<tr><td>Company Head</td><td>
 ...
 <select id="company_head" name="company_head">
   <option value="" disabled selected>---Select Company Head---</option>
   <?php 
...
<tr><td>Reasonal Head</td><td>
 ...
 <select id="reasonal_head" name="reasonal_head">
   <option value="" disabled selected>---Select Reasonal Head---</option>
   <?php 
