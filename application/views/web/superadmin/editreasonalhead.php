  ...
  <div class="col-xs-12">
    <div class="box">
      <div class="box-header">
        <h3 class="box-title"><b>Edit Reasonal Head</b></h3>
      </div><!-- /.box-header -->
      <div class="box-body">
...
<form name="addcompanyhead" id="addcompanyhead" method="post" action="<?php echo base_url()?>web/Superadmin/editreasonalheadprocess">

<table class="table table-bordered table-striped dataTable" id="example1" role="grid" aria-describedby="example1_info">
  <input id="reasonal_head_id" name="reasonal_head_id" type="hidden" value="<?php echo $data['reasonal_head_id']; ?>" autocomplete="off">
 ...
 <tr><td>Address</td><td>
 <div class="form-group has-feedback" style="float: left; margin-left: 10px;">
...
<tr><td>Company Head</td><td>
 <div class="form-group has-feedback" style="float: left;">
 <select id="company_head" name="company_head">
   <option value="<?php echo $data['company_head']; ?>"  selected><?php echo $data['company_head_name']; ?></option>
   <?php 
   foreach ($companyheads as $key => $value) 
   {  
    if ($value['full_name'] != $data['company_head_name']) {
    ?>
    <option value="<?php echo $value['company_head_id'];?>"><?php echo $value['full_name'];?> </option>   
   <?php
    }
   } 
   ?>
 ...
 <div id="company_head-error" style="float: left; margin-left: 10px;"></div>
</td></tr>
...
<script>
  ...
  $(function(){
      $("#submitt").on("click", function(event){
        ...
        if ($("#company_head").val() == null) {
          formStatus = false;      
          $("#company_head-error" ).text( "Please select Company Head." ).show().fadeOut( 3000 ); 
        } 
