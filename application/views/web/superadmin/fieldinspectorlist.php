		...
		<div class="box">
			...
			<div class="box-body">
				<div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
					<div class="row">
						<div class="col-sm-2">
						  <a href="<?php echo base_url();?>web/Superadmin/addfieldinspector"><p style="border: 1px solid;width: 173px;padding: 8px;background: #062758;color: white;border-color: #062758;border-radius: 4px;text-align: center;">Add Field Inspector</p></a>
						</div>
						<div class="col-sm-5">
						 ...
						 ?>
							<?php $i++; ?>
								<tr role="row" class="odd">
									...
									<td>0</td>
									<td><a class="btn btn-success" href="<?php echo base_url()?>web/Superadmin/viewfi?id=<?php echo $data['field_inspector_id'];?>">View</a>
									</td>
									<td>
										<a class="btn btn-success" href="<?php echo base_url()?>web/Superadmin/editfi?id=<?php echo $data['field_inspector_id'];?>">Edit</a>
									</td>
									<td>
										<?php 
										if ($data['status'] == '1') 
