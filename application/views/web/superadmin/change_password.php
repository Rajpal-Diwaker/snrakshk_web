...
<form name="change_password" id="change_password" method="post" action="<?php echo base_url();?>web/Superadmin/changepasswordprocess">
...
<div >
   <a href="<?php echo base_url();?>web/Superadmin/companyheadlist"><input type="button" name="submit" value="Cancel" class="btn btn-primary">
   </a>
...
equalTo: "#new_pass"
      ...
      submitHandler: function(form){  
         ...
         //form.submit(); 
          ...
          url: "<?php echo base_url()?>web/Superadmin/changepasswordprocess",
          type: 'POST',
