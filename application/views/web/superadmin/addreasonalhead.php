  ...
  <div class="col-xs-12">
    <div class="box">
      <div class="box-header">
        <h3 class="box-title"><b>Add Reasonal Head</b></h3>
      </div><!-- /.box-header -->
      <div class="box-body">
...
<form name="addcompanyhead" id="addcompanyhead" method="post" action="<?php echo base_url()?>web/Superadmin/resonalheadprocess">
