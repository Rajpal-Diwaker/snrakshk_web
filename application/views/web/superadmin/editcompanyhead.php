  ...
  <div class="col-xs-12">
    <div class="box">
      <div class="box-header">
        <h3 class="box-title"><b>Edit Company Head</b></h3>
      </div><!-- /.box-header -->
      <div class="box-body">
...
<table class="table table-bordered table-striped dataTable" id="example1" role="grid" aria-describedby="example1_info">
  <input id="company_head_id" name="company_head_id" type="hidden" value="<?php echo $data['company_head_id'];?>" autocomplete="off">
 ...
 <div class="form-group has-feedback" style="float: left;">
 <input class="form-control" id="aadhar_number" name="aadhar_number" maxlength="13" type="text" value="<?php echo $data['aadhar_number']; ?>" autocomplete="off">
 </div>
