  ...
  <div class="col-xs-12">
    <div class="box">
      <div class="box-header">
        <h3 class="box-title"><b>Supervisor</b></h3>
      </div><!-- /.box-header -->
      <div class="box-body">
...
<form name="addcompanyhead" id="addcompanyhead" method="post" action="<?php echo base_url()?>web/Superadmin/editsupervisorprocess">

<table class="table table-bordered table-striped dataTable" id="example1" role="grid" aria-describedby="example1_info">
  <input id="supervisor_id" name="supervisor_id" type="hidden" value="<?php echo $data['supervisor_id']; ?>" autofocus>
...
<tr><td>Reasonal Head</td><td>
 ...
 <div id="reasonal_head-error"></div>
</td></tr>
